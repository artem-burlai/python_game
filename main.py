...
bg_image = pygame.image.load("images/bg9.png")
...
class Player:
    def __init__(self):
        ...
        for num in range(1, 5):
            img_right = pygame.image.load(f"images/player1.png")
        ...
        if game_over == 0:
            ...
            if pygame.sprite.spritecollide(self, lava_group, False):
                ...
                if self.lives <= 0:
                    ...
                    self.rect.x, self.rect.y = 100, height - 130
...
class World:
    def __init__(self, data):
        ...
        door_img = pygame.image.load("images/door4.png")
        diamond_img = pygame.image.load("images/diamond3.png")
        ...
        for row in data:
            ...
            for tile in row:
                if tile == 1 or tile == 2:
                    images = {1: dirt_img, 2: grass_img, 3: lava_img, 5: door_img, 7: diamond_img }
                ...
                if tile == 7:
                    coin = Coin(col_count * tile_size + (tile_size // 2),
                                row_count * tile_size - (tile_size // 1))
                    coin_group.add(coin)
...
restart_button = Button(width // 2, height // 2, "images/restart_btn6.png")
start_button = Button(width // 2 - 150, height // 2, "images/start_btn6.png")
exit_button = Button(width // 2 + 150, height // 2, "images/exit_btn6.png")
...
coin_group.add(Coin(320,600))
coin_group.add(Coin(380,540))
coin_group.add(coin)
...
while run:
    ...
    if main_menu:
        ...
        draw_text(str(score), (255, 255, 255), 30, 10, 60)
        lava_group.update()
